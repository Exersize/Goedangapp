...
import com.example.goedangapp.databinding.FragmentStockOutBinding
import com.example.goedangapp.util.ResultState
import kotlinx.coroutines.launch

class StockOutFragment : Fragment() {
    private var _binding: FragmentStockOutBinding? = null
    private val binding get() = _binding!!
    private lateinit var autoCompleteTextView: AutoCompleteTextView
    private var selectedItem: String? = null
    private lateinit var adapterItems: ArrayAdapter<String>
    private val viewModel: StockOutViewModel by viewModels<StockOutViewModel> {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentStockOutBinding.inflate(inflater, container, false)
        return binding.root
    }
